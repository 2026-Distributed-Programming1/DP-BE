...
import org.dpbe.old.dao.EducationExecutionDAO;
import org.dpbe.old.dao.EducationPlanDAO;
import org.dpbe.old.dao.EducationPreparationDAO;
...
public class EducationExecutionRunner {
    ...
    public static void run() {
        ...
        String educationName = EducationPlanDAO.findAll().stream()
                ...
                .map(EducationPlan::getEducationName)
                .findFirst().orElse("-");
