package org.dpbe.claim;

import org.dpbe.actor.ClaimsHandler;
import org.dpbe.enums.InvestigationResult;
...
public class DamageInvestigation {
    ...
    private org.dpbe.claim.SupplementRequest supplementRequest;                // 보완 서류 요청 (A1)
    ...
    /** 보완 서류 요청 (A1) */
    public org.dpbe.claim.SupplementRequest requestSupplement(List<String> items, String msg) {
        this.supplementRequest = new org.dpbe.claim.SupplementRequest(items, msg);
    ...
    public org.dpbe.claim.SupplementRequest getSupplementRequest() { return supplementRequest; }
