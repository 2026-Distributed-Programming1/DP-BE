...
import org.dpbe.dao.ChannelScreeningDAO;
import org.dpbe.enums.ChannelType;
import org.dpbe.runner.ConsoleHelper;
import org.dpbe.sales.ChannelScreening;
    ...
    public static void run() {
        ...
        List<ChannelScreening> filtered = screeningList.stream()
                ...
                .filter(s -> statusFilter == 1 || s.getScreeningStatus() != null
                        && ((statusFilter == 2 && s.getScreeningStatus() == org.dpbe.enums.ScreeningStatus.PENDING)
                            || (statusFilter == 3 && s.getScreeningStatus() == org.dpbe.enums.ScreeningStatus.APPROVED)
                            || (statusFilter == 4 && s.getScreeningStatus() == org.dpbe.enums.ScreeningStatus.REJECTED)))
