...
public class DispatchRecord {
    ...
    private List<DispatchPhoto> photos;         // 사진 목록 - 전경/파손/번호판/블랙박스
    ...
    /**
     * 사진 카테고리별 업로드
     * 카테고리 정보는 DispatchPhoto의 의미상 속성이지만 다이어그램에 별도 필드는 없으므로
     * 본 구현에서는 단순히 사진 목록에 추가하는 방식으로 처리한다.
     */
    public void uploadPhoto(String category, DispatchPhoto photo) {
        this.photos.add(photo);
        // 처리 필요
    }

    /** 사진 삭제 */
    public void removePhoto(DispatchPhoto photo) {
    ...
    public List<DispatchPhoto> getPhotos() { return photos; }
