...
>
> **▶ 다음 작업 (RESUME HERE)**: **배치 4 — sales 도메인** (channel_recruitments·channel_screenings·activity_plans·sales_activity_managements·sales_org_evaluations·bonus_requests, 6테이블). 배치 3(consultation) 전체 완료 ✅. 착수 시 `Batch4_Sales_Plan.md` 세부 계획부터 수립 권장. 작업 규칙은 **`CLAUDE.md` 「전환 작업 원칙」·「전환 구현 체크리스트」** 준수.
...
- [ ] **배치 4: sales** ◀ 다음 / **5: education+inquiry+마스터** — UC 신규 전환 + surrogate-PK (부록 A.6)
