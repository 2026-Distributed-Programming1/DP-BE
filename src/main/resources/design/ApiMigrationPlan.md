...
> **현재 상태 (2026-05-31)**: 패키지 구조 개편 ✅ · 파일럿 2개(계약 조회·보험료 납입) ✅ · Spring `@Transactional` ✅ · 시더 ✅ · surrogate-PK **배치 1~6 ✅** · **배치 6 완료** — PK 파운데이션(5테이블) ✅ · 환급 3종 ✅ · 해지 ✅ · 계약통계 ✅ · 만기관리 ✅. **전 UC 전환 완료.**
>
> **▶ 다음 작업 (RESUME HERE)**: **최종 수렴** — `old/`(DBA·DAO·Runner) 삭제 + format-on-read + FK를 id로 전환. 또는 로깅 slf4j 확대.
